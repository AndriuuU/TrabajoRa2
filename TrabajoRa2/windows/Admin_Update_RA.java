...
public class Admin_Update_RA extends JFrame {
	...
	public Admin_Update_RA() {

		super("Details_ModifyRA");
		setSize(450, 360);
		...
		btSave.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Ra raNew = new Ra(txId.getText(), txName.getText(), txDescrip.getText(),
						Float.parseFloat(txWeigth.getText()), sub);
				c.updateRa(raNew);
