...
public class Admin_Update_Teacher extends JFrame {
	...
	public Admin_Update_Teacher(Teacher s) {

		super("Admin_Update_Teacher");
		setSize(500, 400);
		...
		btnRegister.setBounds(310, 301, 26, 26);
